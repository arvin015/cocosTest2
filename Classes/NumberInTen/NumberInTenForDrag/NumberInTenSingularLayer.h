...
#ifndef NumberInTenSingularLayer_h
#define NumberInTenSingularLayer_h

#include <stdio.h>
#include "BaseNumberInTenDragLayer.h"

class NumberInTenSingularLayer
: public BaseNumberInTenDragLayer
, NumberInTenDragImpl {
  
public:
    
    NumberInTenSingularLayer();
    ~NumberInTenSingularLayer();
    ...
    CREATE_FUNC(NumberInTenSingularLayer);
